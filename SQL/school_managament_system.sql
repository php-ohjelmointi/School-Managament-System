...
--
-- Host: 127.0.0.1
-- Generation Time: May 30, 2023 at 01:08 AM
...
INSERT INTO `countrys` (`CountryCode`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
('ABW', 'Aruba', 'North America', 'Caribbean', 193.00, 0, 103000, 78.4, 828.00, 793.00, 'Aruba', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 129, 'AW'),
('AFG', 'Afghanistan', 'Asia', 'Southern and Central Asia', 652090.00, 1919, 22720000, 45.9, 5976.00, 0.00, 'Afganistan/Afqanestan', 'Islamic Emirate', 'Mohammad Omar', 1, 'AF'),
...
('AIA', 'Anguilla', 'North America', 'Caribbean', 96.00, 0, 8000, 76.1, 63.20, 0.00, 'Anguilla', 'Dependent Territory of the UK', 'Elisabeth II', 62, 'AI'),
('ALB', 'Albania', 'Europe', 'Southern Europe', 28748.00, 1912, 3401200, 71.6, 3205.00, 2500.00, 'Shqipëria', 'Republic', 'Rexhep Mejdani', 34, 'AL'),
('AND', 'Andorra', 'Europe', 'Southern Europe', 468.00, 1278, 78000, 83.5, 1630.00, 0.00, 'Andorra', 'Parliamentary Coprincipality', '', 55, 'AD'),
('ANT', 'Netherlands Antilles', 'North America', 'Caribbean', 800.00, 0, 217000, 74.7, 1941.00, 0.00, 'Nederlandse Antillen', 'Nonmetropolitan Territory of The Netherlands', 'Beatrix', 33, 'AN'),
...
('ASM', 'American Samoa', 'Oceania', 'Polynesia', 199.00, 0, 68000, 75.1, 334.00, 0.00, 'Amerika Samoa', 'US Territory', 'George W. Bush', 54, 'AS'),
('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 13120000.00, 0, 0, 0.0, 0.00, 0.00, '–', 'Co-administrated', '', 0, 'AQ'),
('ATF', 'French Southern territories', 'Antarctica', 'Antarctica', 7780.00, 0, 0, 0.0, 0.00, 0.00, 'Terres australes françaises', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 0, 'TF'),
...
('BIH', 'Bosnia and Herzegovina', 'Europe', 'Southern Europe', 51197.00, 1992, 3972000, 71.5, 2841.00, 0.00, 'Bosna i Hercegovina', 'Federal Republic', 'Ante Jelavic', 201, 'BA'),
('BLR', 'Belarus', 'Europe', 'Eastern Europe', 207600.00, 1991, 10236000, 68.0, 13714.00, 0.00, 'Belarus', 'Republic', 'Aljaksandr Lukašenka', 3520, 'BY'),
...
('BMU', 'Bermuda', 'North America', 'North America', 53.00, 0, 65000, 76.9, 2328.00, 2190.00, 'Bermuda', 'Dependent Territory of the UK', 'Elisabeth II', 191, 'BM'),
...
('BVT', 'Bouvet Island', 'Antarctica', 'Antarctica', 59.00, 0, 0, 0.0, 0.00, 0.00, 'Bouvetøya', 'Dependent Territory of Norway', 'Harald V', 0, 'BV'),
...
('CCK', 'Cocos (Keeling) Islands', 'Oceania', 'Australia and New Zealand', 14.00, 0, 600, 0.0, 0.00, 0.00, 'Cocos (Keeling) Islands', 'Territory of Australia', 'Elisabeth II', 2317, 'CC'),
...
('COK', 'Cook Islands', 'Oceania', 'Polynesia', 236.00, 0, 20000, 71.1, 100.00, 0.00, 'The Cook Islands', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 583, 'CK'),
...
('CXR', 'Christmas Island', 'Oceania', 'Australia and New Zealand', 135.00, 0, 2500, 0.0, 0.00, 0.00, 'Christmas Island', 'Territory of Australia', 'Elisabeth II', 1791, 'CX'),
('CYM', 'Cayman Islands', 'North America', 'Caribbean', 264.00, 0, 38000, 78.9, 1263.00, 1186.00, 'Cayman Islands', 'Dependent Territory of the UK', 'Elisabeth II', 553, 'KY'),
...
('ESH', 'Western Sahara', 'Africa', 'Northern Africa', 266000.00, 0, 293000, 49.8, 60.00, 0.00, 'As-Sahrawiya', 'Occupied by Marocco', 'Mohammed Abdel Aziz', 2453, 'EH'),
...
('FLK', 'Falkland Islands', 'South America', 'South America', 12173.00, 0, 2000, 0.0, 0.00, 0.00, 'Falkland Islands', 'Dependent Territory of the UK', 'Elisabeth II', 763, 'FK'),
...
('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 1399.00, 0, 43000, 78.4, 0.00, 0.00, 'Føroyar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
('FSM', 'Micronesia, Federated States of', 'Oceania', 'Micronesia', 702.00, 1990, 119000, 68.6, 212.00, 0.00, 'Micronesia', 'Federal Republic', 'Leo A. Falcam', 2689, 'FM'),
...
('GIB', 'Gibraltar', 'Europe', 'Southern Europe', 6.00, 0, 25000, 79.0, 258.00, 0.00, 'Gibraltar', 'Dependent Territory of the UK', 'Elisabeth II', 915, 'GI'),
('GIN', 'Guinea', 'Africa', 'Western Africa', 245857.00, 1958, 7430000, 45.6, 2352.00, 2383.00, 'Guinée', 'Republic', 'Lansana Conté', 926, 'GN'),
('GLP', 'Guadeloupe', 'North America', 'Caribbean', 1705.00, 0, 456000, 77.0, 3501.00, 0.00, 'Guadeloupe', 'Overseas Department of France', 'Jacques Chirac', 919, 'GP'),
...
('GRD', 'Grenada', 'North America', 'Caribbean', 344.00, 1974, 94000, 64.5, 318.00, 0.00, 'Grenada', 'Constitutional Monarchy', 'Elisabeth II', 916, 'GD'),
('GRL', 'Greenland', 'North America', 'North America', 2166090.00, 0, 56000, 68.1, 0.00, 0.00, 'Kalaallit Nunaat/Grønland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
...
('GUF', 'French Guiana', 'South America', 'South America', 90000.00, 0, 181000, 76.1, 681.00, 0.00, 'Guyane française', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
('GUM', 'Guam', 'Oceania', 'Micronesia', 549.00, 0, 168000, 77.8, 1197.00, 1136.00, 'Guam', 'US Territory', 'George W. Bush', 921, 'GU'),
('GUY', 'Guyana', 'South America', 'South America', 214969.00, 1966, 861000, 64.0, 722.00, 743.00, 'Guyana', 'Republic', 'Bharrat Jagdeo', 928, 'GY'),
('HKG', 'Hong Kong', 'Asia', 'Eastern Asia', 1075.00, 0, 6782000, 79.5, 166448.00, 173610.00, 'Xianggang/Hong Kong', 'Special Administrative Region of China', 'Jiang Zemin', 937, 'HK'),
('HMD', 'Heard Island and McDonald Islands', 'Antarctica', 'Antarctica', 359.00, 0, 0, 0.0, 0.00, 0.00, 'Heard and McDonald Islands', 'Territory of Australia', 'Elisabeth II', 0, 'HM'),
...
('IOT', 'British Indian Ocean Territory', 'Africa', 'Eastern Africa', 78.00, 0, 0, 0.0, 0.00, 0.00, 'British Indian Ocean Territory', 'Dependent Territory of the UK', 'Elisabeth II', 0, 'IO'),
...
('IRQ', 'Iraq', 'Asia', 'Middle East', 438317.00, 1932, 23115000, 66.5, 11500.00, 0.00, 'Al-´Iraq', 'Republic', 'Saddam Hussein al-Takriti', 1365, 'IQ'),
...
('KIR', 'Kiribati', 'Oceania', 'Micronesia', 726.00, 1979, 83000, 59.8, 40.70, 0.00, 'Kiribati', 'Republic', 'Teburoro Tito', 2256, 'KI'),
('KNA', 'Saint Kitts and Nevis', 'North America', 'Caribbean', 261.00, 1983, 38000, 70.7, 299.00, 0.00, 'Saint Kitts and Nevis', 'Constitutional Monarchy', 'Elisabeth II', 3064, 'KN'),
...
('LBR', 'Liberia', 'Africa', 'Western Africa', 111369.00, 1847, 3154000, 51.0, 2012.00, 0.00, 'Liberia', 'Republic', 'Charles Taylor', 2440, 'LR'),
...
('LCA', 'Saint Lucia', 'North America', 'Caribbean', 622.00, 1979, 154000, 72.3, 571.00, 0.00, 'Saint Lucia', 'Constitutional Monarchy', 'Elisabeth II', 3065, 'LC'),
...
('MAC', 'Macao', 'Asia', 'Eastern Asia', 18.00, 0, 473000, 81.6, 5749.00, 5940.00, 'Macau/Aomen', 'Special Administrative Region of China', 'Jiang Zemin', 2454, 'MO'),
...
('MCO', 'Monaco', 'Europe', 'Western Europe', 1.50, 1861, 34000, 78.8, 776.00, 0.00, 'Monaco', 'Constitutional Monarchy', 'Rainier III', 2695, 'MC'),
...
('MDV', 'Maldives', 'Asia', 'Southern and Central Asia', 298.00, 1965, 286000, 62.2, 199.00, 0.00, 'Dhivehi Raajje/Maldives', 'Republic', 'Maumoon Abdul Gayoom', 2463, 'MV'),
...
('MHL', 'Marshall Islands', 'Oceania', 'Micronesia', 181.00, 1990, 64000, 65.5, 97.00, 0.00, 'Marshall Islands/Majol', 'Republic', 'Kessai Note', 2507, 'MH'),
...
('MNP', 'Northern Mariana Islands', 'Oceania', 'Micronesia', 464.00, 0, 78000, 75.5, 0.00, 0.00, 'Northern Mariana Islands', 'Commonwealth of the US', 'George W. Bush', 2913, 'MP'),
...
('MSR', 'Montserrat', 'North America', 'Caribbean', 102.00, 0, 11000, 78.0, 109.00, 0.00, 'Montserrat', 'Dependent Territory of the UK', 'Elisabeth II', 2697, 'MS'),
('MTQ', 'Martinique', 'North America', 'Caribbean', 1102.00, 0, 395000, 78.3, 2731.00, 2559.00, 'Martinique', 'Overseas Department of France', 'Jacques Chirac', 2508, 'MQ'),
...
('MYT', 'Mayotte', 'Africa', 'Eastern Africa', 373.00, 0, 149000, 59.5, 0.00, 0.00, 'Mayotte', 'Territorial Collectivity of France', 'Jacques Chirac', 2514, 'YT'),
('NAM', 'Namibia', 'Africa', 'Southern Africa', 824292.00, 1990, 1726000, 42.5, 3101.00, 3384.00, 'Namibia', 'Republic', 'Sam Nujoma', 2726, 'NA'),
('NCL', 'New Caledonia', 'Oceania', 'Melanesia', 18575.00, 0, 214000, 72.8, 3563.00, 0.00, 'Nouvelle-Calédonie', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3493, 'NC'),
('NER', 'Niger', 'Africa', 'Western Africa', 1267000.00, 1960, 10730000, 41.3, 1706.00, 1580.00, 'Niger', 'Republic', 'Mamadou Tandja', 2738, 'NE'),
('NFK', 'Norfolk Island', 'Oceania', 'Australia and New Zealand', 36.00, 0, 2000, 0.0, 0.00, 0.00, 'Norfolk Island', 'Territory of Australia', 'Elisabeth II', 2806, 'NF'),
...
('NIU', 'Niue', 'Oceania', 'Polynesia', 260.00, 0, 2000, 0.0, 0.00, 0.00, 'Niue', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 2805, 'NU'),
...
('NRU', 'Nauru', 'Oceania', 'Micronesia', 21.00, 1968, 12000, 60.8, 197.00, 0.00, 'Naoero/Nauru', 'Republic', 'Bernard Dowiyogo', 2728, 'NR'),
...
('PCN', 'Pitcairn', 'Oceania', 'Polynesia', 49.00, 0, 50, 0.0, 0.00, 0.00, 'Pitcairn', 'Dependent Territory of the UK', 'Elisabeth II', 2912, 'PN'),
...
('PLW', 'Palau', 'Oceania', 'Micronesia', 459.00, 1994, 19000, 68.6, 105.00, 0.00, 'Belau/Palau', 'Republic', 'Kuniwo Nakamura', 2881, 'PW'),
...
('PRI', 'Puerto Rico', 'North America', 'Caribbean', 8875.00, 0, 3869000, 75.6, 34100.00, 32100.00, 'Puerto Rico', 'Commonwealth of the US', 'George W. Bush', 2919, 'PR'),
('PRK', 'North Korea', 'Asia', 'Eastern Asia', 120538.00, 1948, 24039000, 70.7, 5332.00, 0.00, 'Choson Minjujuui In´min Konghwaguk (Bukhan)', 'Socialistic Republic', 'Kim Jong-il', 2318, 'KP'),
...
('PSE', 'Palestine', 'Asia', 'Middle East', 6257.00, 0, 3101000, 71.4, 4173.00, 0.00, 'Filastin', 'Autonomous Area', 'Yasser (Yasir) Arafat', 4074, 'PS'),
('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4000.00, 0, 235000, 74.8, 818.00, 781.00, 'Polynésie française', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3016, 'PF'),
('QAT', 'Qatar', 'Asia', 'Middle East', 11000.00, 1971, 599000, 72.4, 9472.00, 8920.00, 'Qatar', 'Monarchy', 'Hamad ibn Khalifa al-Thani', 2973, 'QA'),
('REU', 'Réunion', 'Africa', 'Eastern Africa', 2510.00, 0, 699000, 72.7, 8287.00, 7988.00, 'Réunion', 'Overseas Department of France', 'Jacques Chirac', 3017, 'RE'),
...
('SDN', 'Sudan', 'Africa', 'Northern Africa', 2505813.00, 1956, 29490000, 56.6, 10162.00, 0.00, 'As-Sudan', 'Islamic Republic', 'Omar Hassan Ahmad al-Bashir', 3225, 'SD'),
...
('SGS', 'South Georgia and the South Sandwich Islands', 'Antarctica', 'Antarctica', 3903.00, 0, 0, 0.0, 0.00, 0.00, 'South Georgia and the South Sandwich Islands', 'Dependent Territory of the UK', 'Elisabeth II', 0, 'GS'),
('SHN', 'Saint Helena', 'Africa', 'Western Africa', 314.00, 0, 6000, 76.8, 0.00, 0.00, 'Saint Helena', 'Dependent Territory of the UK', 'Elisabeth II', 3063, 'SH'),
('SJM', 'Svalbard and Jan Mayen', 'Europe', 'Nordic Countries', 62422.00, 0, 3200, 0.0, 0.00, 0.00, 'Svalbard og Jan Mayen', 'Dependent Territory of Norway', 'Harald V', 938, 'SJ'),
...
('SMR', 'San Marino', 'Europe', 'Southern Europe', 61.00, 885, 27000, 81.1, 510.00, 0.00, 'San Marino', 'Republic', '', 3171, 'SM'),
('SOM', 'Somalia', 'Africa', 'Eastern Africa', 637657.00, 1960, 10097000, 46.2, 935.00, 0.00, 'Soomaaliya', 'Republic', 'Abdiqassim Salad Hassan', 3214, 'SO'),
('SPM', 'Saint Pierre and Miquelon', 'North America', 'North America', 242.00, 0, 7000, 77.6, 0.00, 0.00, 'Saint-Pierre-et-Miquelon', 'Territorial Collectivity of France', 'Jacques Chirac', 3067, 'PM'),
('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 964.00, 1975, 147000, 65.3, 6.00, 0.00, 'São Tomé e Príncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
...
('TCA', 'Turks and Caicos Islands', 'North America', 'Caribbean', 430.00, 0, 17000, 73.3, 96.00, 0.00, 'The Turks and Caicos Islands', 'Dependent Territory of the UK', 'Elisabeth II', 3423, 'TC'),
...
('TKL', 'Tokelau', 'Oceania', 'Polynesia', 12.00, 0, 2000, 0.0, 0.00, 0.00, 'Tokelau', 'Nonmetropolitan Territory of New Zealand', 'Elisabeth II', 3333, 'TK'),
...
('TMP', 'East Timor', 'Asia', 'Southeast Asia', 14874.00, 0, 885000, 46.0, 0.00, 0.00, 'Timor Timur', 'Administrated by the UN', 'José Alexandre Gusmão', 1522, 'TP'),
...
('TUV', 'Tuvalu', 'Oceania', 'Polynesia', 26.00, 1978, 12000, 66.3, 6.00, 0.00, 'Tuvalu', 'Constitutional Monarchy', 'Elisabeth II', 3424, 'TV'),
...
('UMI', 'United States Minor Outlying Islands', 'Oceania', 'Micronesia/Caribbean', 16.00, 0, 0, 0.0, 0.00, 0.00, 'United States Minor Outlying Islands', 'Dependent Territory of the US', 'George W. Bush', 0, 'UM'),
...
('VAT', 'Holy See (Vatican City State)', 'Europe', 'Southern Europe', 0.40, 1929, 1000, 0.0, 9.00, 0.00, 'Santa Sede/Città del Vaticano', 'Independent Church State', 'Johannes Paavali II', 3538, 'VA'),
('VCT', 'Saint Vincent and the Grenadines', 'North America', 'Caribbean', 388.00, 1979, 114000, 72.3, 285.00, 0.00, 'Saint Vincent and the Grenadines', 'Constitutional Monarchy', 'Elisabeth II', 3066, 'VC'),
...
('VGB', 'Virgin Islands, British', 'North America', 'Caribbean', 151.00, 0, 21000, 75.4, 612.00, 573.00, 'British Virgin Islands', 'Dependent Territory of the UK', 'Elisabeth II', 537, 'VG'),
('VIR', 'Virgin Islands, U.S.', 'North America', 'Caribbean', 347.00, 0, 93000, 78.1, 0.00, 0.00, 'Virgin Islands of the United States', 'US Territory', 'George W. Bush', 4067, 'VI'),
...
('WLF', 'Wallis and Futuna', 'Oceania', 'Polynesia', 200.00, 0, 15000, 0.0, 0.00, 0.00, 'Wallis-et-Futuna', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3536, 'WF'),
...
('YUG', 'Yugoslavia', 'Europe', 'Southern Europe', 102173.00, 1918, 10640000, 72.4, 17000.00, 0.00, 'Jugoslavija', 'Federal Republic', 'Vojislav Koštunica', 1792, 'YU'),
...
CREATE TABLE `subjects` (
  ...
  `IsLanguage` tinyint(4) DEFAULT NULL,
...
ALTER TABLE `classrooms_cources`
  ...
  ADD KEY `ClassRooms_Cources_ClassRooms` (`Room_ID`),
  ADD KEY `ClassRooms_Cources_Cources` (`Cource_ID`),
  ADD KEY `ClassRooms_Cources_Staffs` (`AddByWho`),
  ADD KEY `ClassRooms_Cources_Staffs_1` (`UpdateByWho`);

--
-- Indexes for table `countrylanguage`
--
ALTER TABLE `countrylanguage`
  ADD KEY `Langauge` (`Language`),
  ADD KEY `CountryCode` (`CountryCode`);
...
ALTER TABLE `courseattendanse`
  ADD PRIMARY KEY (`Row_ID`),
  ADD KEY `CourseAttendanse_Students` (`Student_ID`),
  ADD KEY `CourseAttendanse_Cources` (`Cource_ID`);
...
ALTER TABLE `gradelines`
  ADD PRIMARY KEY (`Row_ID`),
  ADD KEY `GradeLines_Grades` (`Grade_Code`),
  ADD KEY `GradeLines_Cources` (`Cource_ID`),
  ADD KEY `GradeLines_Students` (`Student_ID`),
  ADD KEY `GradeLines_Staffs` (`Staff_ID`);
...
ALTER TABLE `logintransaction`
  ...
  ADD KEY `LoginTraction_Usernames` (`User_ID`);
...
ALTER TABLE `staffcources`
  ADD PRIMARY KEY (`Row_ID`),
  ADD KEY `StaffCources_Cources` (`Cource_ID`),
  ADD KEY `StaffCources_Staffs` (`Staff_ID`);
...
ALTER TABLE `staffleaves`
  ADD PRIMARY KEY (`Row_ID`),
  ADD KEY `StaffLeaves_LeavesPourpose` (`LeavesPourppose_ID`),
  ADD KEY `StaffLeaves_Staffs` (`Staff_ID`);
...
ALTER TABLE `staffs`
  ...
  ADD KEY `Staffs_StaffTitle` (`Title_ID`),
  ADD KEY `Staffs_Postalcodes` (`PostNumber`);
...
ALTER TABLE `stafftypes`
  ...
  ADD KEY `StaffTypes_Staffs` (`Staff_ID`);
...
ALTER TABLE `students`
  ...
  ADD KEY `Students_Postalcodes` (`PostNumber`);
...
--
ALTER TABLE `city`
  ADD CONSTRAINT `city_countrys` FOREIGN KEY (`CountryCode`) REFERENCES `countrys` (`CountryCode`);

--
-- Constraints for table `classrooms_cources`
--
ALTER TABLE `classrooms_cources`
  ADD CONSTRAINT `ClassRooms_Cources_ClassRooms` FOREIGN KEY (`Room_ID`) REFERENCES `classrooms` (`Room_ID`),
  ADD CONSTRAINT `ClassRooms_Cources_Cources` FOREIGN KEY (`Cource_ID`) REFERENCES `cources` (`Cource_ID`),
  ADD CONSTRAINT `ClassRooms_Cources_Staffs` FOREIGN KEY (`AddByWho`) REFERENCES `staffs` (`Staff_ID`),
  ADD CONSTRAINT `ClassRooms_Cources_Staffs_1` FOREIGN KEY (`UpdateByWho`) REFERENCES `staffs` (`Staff_ID`);

--
-- Constraints for table `countrylanguage`
--
ALTER TABLE `countrylanguage`
  ADD CONSTRAINT `countrylanguage_Countrys` FOREIGN KEY (`CountryCode`) REFERENCES `countrys` (`CountryCode`);

--
-- Constraints for table `cource_subjects`
--
ALTER TABLE `cource_subjects`
  ADD CONSTRAINT `Cource_Subjects_Cources` FOREIGN KEY (`Cource_ID`) REFERENCES `cources` (`Cource_ID`),
  ADD CONSTRAINT `Cource_Subjects_Subjects` FOREIGN KEY (`Subject_ID`) REFERENCES `subjects` (`Subject_ID`);

--
-- Constraints for table `courseattendanse`
--
ALTER TABLE `courseattendanse`
  ADD CONSTRAINT `CourseAttendanse_Cources` FOREIGN KEY (`Cource_ID`) REFERENCES `cources` (`Cource_ID`),
  ADD CONSTRAINT `CourseAttendanse_Students` FOREIGN KEY (`Student_ID`) REFERENCES `students` (`Student_ID`);

--
-- Constraints for table `gradelines`
--
ALTER TABLE `gradelines`
  ADD CONSTRAINT `GradeLines_Cources` FOREIGN KEY (`Cource_ID`) REFERENCES `cources` (`Cource_ID`),
  ADD CONSTRAINT `GradeLines_Grades` FOREIGN KEY (`Grade_Code`) REFERENCES `grades` (`Grade_Code`),
  ADD CONSTRAINT `GradeLines_Staffs` FOREIGN KEY (`Staff_ID`) REFERENCES `staffs` (`Staff_ID`),
  ADD CONSTRAINT `GradeLines_Students` FOREIGN KEY (`Student_ID`) REFERENCES `students` (`Student_ID`);

--
-- Constraints for table `logintransaction`
--
ALTER TABLE `logintransaction`
  ADD CONSTRAINT `LoginTraction_Usernames` FOREIGN KEY (`User_ID`) REFERENCES `usernames` (`User_ID`);

--
-- Constraints for table `staffcources`
--
ALTER TABLE `staffcources`
  ADD CONSTRAINT `StaffCources_Cources` FOREIGN KEY (`Cource_ID`) REFERENCES `cources` (`Cource_ID`),
  ADD CONSTRAINT `StaffCources_Staffs` FOREIGN KEY (`Staff_ID`) REFERENCES `staffs` (`Staff_ID`);

--
-- Constraints for table `staffleaves`
--
ALTER TABLE `staffleaves`
  ADD CONSTRAINT `StaffLeaves_LeavesPourpose` FOREIGN KEY (`LeavesPourppose_ID`) REFERENCES `leavespourpose` (`LeavesPourppose_ID`),
  ADD CONSTRAINT `StaffLeaves_Staffs` FOREIGN KEY (`Staff_ID`) REFERENCES `staffs` (`Staff_ID`);

--
-- Constraints for table `staffs`
--
ALTER TABLE `staffs`
  ADD CONSTRAINT `Staffs_Postalcodes` FOREIGN KEY (`PostNumber`) REFERENCES `postalcodes` (`PostNumber`),
  ADD CONSTRAINT `Staffs_StaffTitle` FOREIGN KEY (`Title_ID`) REFERENCES `stafftitle` (`Title_ID`);

--
-- Constraints for table `stafftypes`
--
ALTER TABLE `stafftypes`
  ADD CONSTRAINT `StaffTypes_Staffs` FOREIGN KEY (`Staff_ID`) REFERENCES `staffs` (`Staff_ID`);

--
-- Constraints for table `studentleaves`
--
ALTER TABLE `studentleaves`
  ADD CONSTRAINT `StudentLeaves_Students` FOREIGN KEY (`Student_ID`) REFERENCES `students` (`Student_ID`);

--
-- Constraints for table `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `Students_Postalcodes` FOREIGN KEY (`PostNumber`) REFERENCES `postalcodes` (`PostNumber`);

--
-- Constraints for table `subjects`
--
ALTER TABLE `subjects`
  ADD CONSTRAINT `subjects_countrylanguage` FOREIGN KEY (`Language`) REFERENCES `countrylanguage` (`Language`);

--
-- Constraints for table `usernames`
--
ALTER TABLE `usernames`
  ADD CONSTRAINT `Usernames_Staffs` FOREIGN KEY (`Staff_ID`) REFERENCES `staffs` (`Staff_ID`),
  ADD CONSTRAINT `Usernames_Students` FOREIGN KEY (`Student_ID`) REFERENCES `students` (`Student_ID`);
COMMIT;
